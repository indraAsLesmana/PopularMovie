...
public class MovieSyncUtils {
    ...
    public static void CreateSyncAccount(Context context) {
        ...
        Account account = MovieGenericAccountService.GetAccount(ACCOUNT_TYPE);
    ...
    public static void TriggerRefresh() {
        ...
        ContentResolver.requestSync(
                MovieGenericAccountService.GetAccount(ACCOUNT_TYPE), // Sync account
                MovieContract.CONTENT_AUTHORITY,                 // Content authority
                b);                                             // Extras
    }
}

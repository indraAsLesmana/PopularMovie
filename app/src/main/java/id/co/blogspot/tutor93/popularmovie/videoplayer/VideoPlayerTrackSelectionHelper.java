 ...
 */
/* package */ final class VideoPlayerTrackSelectionHelper implements View.OnClickListener,
   ...
   */
  public VideoPlayerTrackSelectionHelper(MappingTrackSelector selector,
  ...
  private View buildView(Context context) {
    ...
    View view = inflater.inflate(R.layout.videoplayer_selection_dialog, null);
    ...
    root.addView(inflater.inflate(R.layout.videoplayer_listdivider, root, false));
